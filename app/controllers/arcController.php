...
class arcController extends mainModel
{
   ...
   public function listarArcControlador($pagina, $registros, $url, $busqueda)
   {
       ...
       JOIN cpi_art_af cpi ON pca.id_cpi_art_af = cpi.id_cpi_art_af AND cpi.id_cpi_art_af = 3
       ...
       WHERE cpi.id_cpi_art_af = 3 AND (p.codigo_producto LIKE '%$busqueda%' OR p.nombre_producto LIKE '%$busqueda%');";
       ...
       function calcularTotales() {
           ...
           filas.forEach(function(fila) {
               ...
               var totalCalculado = arco * multiplicador;
