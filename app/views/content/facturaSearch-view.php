...
<div class="container-fluid mb-4">
    <!-- Título de la página -->
    <h1 class="display-4 text-center">Facturas</h1>
    <!-- Subtítulo de la página -->
    <h2 class="lead text-center">Buscar Factura</h2>
</div>
...
<div class="container py-4">
    <?php
        ...
        $insOrden = new facturaController();

        $opcionesOrdenes = $insOrden->obtenerOpcionesFacturas();
    ...
    <form class="FormularioAjax row g-3 mb-4" action="<?php echo APP_URL; ?>app/ajax/buscadorFacturaAjax.php" method="POST" autocomplete="off" >
        ...
        <div class="mb-3">
                    ...
                    <select class='form-control' name='txt_buscador' id='orden' required>
                        <option value="">¿Qué estas buscando?</option>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <form class="FormularioAjax d-inline-block" action="<?php echo APP_URL; ?>app/ajax/buscadorFacturaAjax.php" method="POST" autocomplete="off" >
            <!-- Campos ocultos para el módulo de búsqueda y la URL del módulo -->
    ...
    <?php
        ...
        echo $insProduct->listarFacturaControlador($url[1],99999999,$url[0],$_SESSION[$url[0]]);
        }
    ?>
