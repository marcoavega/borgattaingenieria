...
<div class="container pb-6 pt-6">
            ...
            <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                ...
                <div class="field is-grouped">
                    <p class="control is-expanded">
                        <input class="input is-rounded" type="text" name="txt_buscador" placeholder="¿Qué estas buscando?"  maxlength="50" required >
                    </p>
                    <p class="control">
    ...
    <?php
            echo $insUsuario->listarProductControlador($url[1],15,$url[0],$_SESSION[$url[0]]);
        }
    ?>
</div>