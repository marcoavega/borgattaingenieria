...
<div class="container-fluid mb-4">
    ...
    <h2 class="lead text-center">Buscar movimientos</h2>
</div>
...
<div class="container py-4">
    <?php
        ...
        $opcionesMovimientos = $insMov->obtenerEmpleados();
    ...
    <form class="FormularioAjax row g-3 mb-4" action="<?php echo APP_URL; ?>app/ajax/buscadorMovAjax.php" method="POST" autocomplete="off" >
        <!-- Campo de entrada para la búsqueda -->
        <div class="mb-3">
                    <label for="orden" class="form-label">Movimientos</label>
                    <select class='form-control' name='txt_buscador' id='orden' required>
                        <option value="">Selección de Nombre de empleado</option>
                        <?php echo $opcionesMovimientos; ?>
                    </select>
                </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <form class="FormularioAjax d-inline-block" action="<?php echo APP_URL; ?>app/ajax/buscadorMovAjax.php" method="POST" autocomplete="off" >
            <!-- Campos ocultos para el módulo de búsqueda y la URL del módulo -->
    ...
    <?php
        ...
        echo $insMov->listarMovControlador($url[1],99999999,$url[0],$_SESSION[$url[0]]);
        }
    ?>
