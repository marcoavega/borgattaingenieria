    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="container-fluid py-4">
                <h4 class="text-center mb-4">Alta de productos en Orden</h4>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <form class="FormularioAjax p-4 border rounded-3" action="<?php echo APP_URL; ?>app/ajax/ordenCompraProductosAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="id_orden_compra" class="form-label">Órdenes de compra</label>
                                <select class='form-select form-select-sm' name='id_orden_compra' id='id_orden_compra' required>
